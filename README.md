...
docker run \
    ...
    --name deephaven \
    -p 10000:10000 \
    ghcr.io/deephaven/server:0.23.0
```
...
* `ghcr.io/deephaven/server:0.23.0`
* `ghcr.io/deephaven/server-slim:0.23.0`
* `ghcr.io/deephaven/server-all-ai:0.23.0`
* `ghcr.io/deephaven/server-nltk:0.23.0`
* `ghcr.io/deephaven/server-pytorch:0.23.0`
* `ghcr.io/deephaven/server-sklearn:0.23.0`
* `ghcr.io/deephaven/server-tensorflow:0.23.0`
