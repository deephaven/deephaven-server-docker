...
docker run \
    ...
    --name deephaven \
    -p 10000:10000 \
    ghcr.io/deephaven/server:0.19.0
```
...
* `ghcr.io/deephaven/server:0.19.0`
* `ghcr.io/deephaven/server-slim:0.19.0`
* `ghcr.io/deephaven/server-scratch:0.19.0`
...
A "scratch" image is also being produced, `ghcr.io/deephaven/server-scratch:0.19.0`.
...
```Dockerfile
COPY --link --from=ghcr.io/deephaven/server-scratch:0.19.0 /opt/deephaven /opt/deephaven
```
