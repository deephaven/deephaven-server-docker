...
docker run \
    ...
    --name deephaven \
    -p 10000:10000 \
    ghcr.io/deephaven/server:0.26.0
```
...
* `ghcr.io/deephaven/server:0.26.0`
* `ghcr.io/deephaven/server-slim:0.26.0`
* `ghcr.io/deephaven/server-all-ai:0.26.0`
* `ghcr.io/deephaven/server-nltk:0.26.0`
* `ghcr.io/deephaven/server-pytorch:0.26.0`
* `ghcr.io/deephaven/server-sklearn:0.26.0`
* `ghcr.io/deephaven/server-tensorflow:0.26.0`
