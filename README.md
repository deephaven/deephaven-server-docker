...
docker run \
    ...
    --name deephaven \
    -p 10000:10000 \
    ghcr.io/deephaven/server:0.29.1
```
...
* `ghcr.io/deephaven/server:0.29.1`
* `ghcr.io/deephaven/server-slim:0.29.1`
* `ghcr.io/deephaven/server-all-ai:0.29.1`
* `ghcr.io/deephaven/server-nltk:0.29.1`
* `ghcr.io/deephaven/server-pytorch:0.29.1`
* `ghcr.io/deephaven/server-sklearn:0.29.1`
* `ghcr.io/deephaven/server-tensorflow:0.29.1`
